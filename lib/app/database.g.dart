...
class $CategoriesTable extends Categories
  ...
  @override
  late final GeneratedColumnWithTypeConverter<JenisKategori, String> type =
      GeneratedColumn<String>(
        'type',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<JenisKategori>($CategoriesTable.$convertertype);
  ...
  static JsonTypeConverter2<JenisKategori, String, String> $convertertype =
      const EnumNameConverter<JenisKategori>(JenisKategori.values);
}
...
class Kategori extends DataClass implements Insertable<Kategori> {
  ...
  Kategori copyWithCompanion(CategoriesCompanion data) {
    return Kategori(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
      type: data.type.present ? data.type.value : this.type,
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, type, color, isDefault, isHidden, sortOrder);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Kategori &&
...
class CategoriesCompanion extends UpdateCompanion<Kategori> {
  final Value<int> id;
  final Value<String> name;
  final Value<JenisKategori> type;
...
class $TransactionsTable extends Transactions
    with TableInfo<$TransactionsTable, Transaksi> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  late final GeneratedColumnWithTypeConverter<JenisTransaksi, String> type =
      GeneratedColumn<String>(
        'type',
        aliasedName,
        false,
        type: DriftSqlType.string,
        requiredDuringInsert: true,
      ).withConverter<JenisTransaksi>($TransactionsTable.$convertertype);
  ...
  static JsonTypeConverter2<JenisTransaksi, String, String> $convertertype =
...
class Transaksi extends DataClass implements Insertable<Transaksi> {
  ...
  Transaksi copyWithCompanion(TransactionsCompanion data) {
    return Transaksi(
      id: data.id.present ? data.id.value : this.id,
      type: data.type.present ? data.type.value : this.type,
...
class TransactionsCompanion extends UpdateCompanion<Transaksi> {
  final Value<int> id;
  final Value<JenisTransaksi> type;
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, categoryId, month, amount];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  Budget copyWith({int? id, int? categoryId, String? month, int? amount}) =>
      Budget(
        id: id ?? this.id,
        categoryId: categoryId ?? this.categoryId,
  ...
  @override
  int get hashCode => Object.hash(id, categoryId, month, amount);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Budget &&
...
class $$CategoriesTableFilterComposer
    extends Composer<_$GemiDatabase, $CategoriesTable> {
  ...
  ColumnWithTypeConverterFilters<JenisKategori, JenisKategori, String>
...
class $$CategoriesTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<JenisKategori, String> get type =>
      $composableBuilder(column: $table.type, builder: (column) => column);
...
class $$CategoriesTableTableManager
    extends
        RootTableManager<
          ...
          (
            Kategori,
            BaseReferences<_$GemiDatabase, $CategoriesTable, Kategori>,
          ),
          Kategori,
          PrefetchHooks Function()
        > {
  $$CategoriesTableTableManager(_$GemiDatabase db, $CategoriesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> name = const Value.absent(),
                Value<JenisKategori> type = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$CategoriesTable, Kategori>(table),
                  BaseReferences<_$GemiDatabase, $CategoriesTable, Kategori>(
                    db,
                    table,
                    e,
...
typedef $$CategoriesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      $$CategoriesTableCreateCompanionBuilder,
      $$CategoriesTableUpdateCompanionBuilder,
      (Kategori, BaseReferences<_$GemiDatabase, $CategoriesTable, Kategori>),
      Kategori,
      PrefetchHooks Function()
    >;
...
class $$TransactionsTableFilterComposer
    extends Composer<_$GemiDatabase, $TransactionsTable> {
...
class $$TransactionsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<JenisTransaksi, String> get type =>
      $composableBuilder(column: $table.type, builder: (column) => column);
...
class $$TransactionsTableTableManager
    extends
        RootTableManager<
          ...
          (
            Transaksi,
            BaseReferences<_$GemiDatabase, $TransactionsTable, Transaksi>,
          ),
          Transaksi,
          PrefetchHooks Function()
        > {
  $$TransactionsTableTableManager(_$GemiDatabase db, $TransactionsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<JenisTransaksi> type = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$TransactionsTable, Transaksi>(table),
                  BaseReferences<_$GemiDatabase, $TransactionsTable, Transaksi>(
                    db,
                    table,
                    e,
...
class $$BudgetsTableFilterComposer
    extends Composer<_$GemiDatabase, $BudgetsTable> {
...
class $$BudgetsTableTableManager
    extends
        RootTableManager<
          ...
          (Budget, BaseReferences<_$GemiDatabase, $BudgetsTable, Budget>),
          Budget,
          PrefetchHooks Function()
        > {
  $$BudgetsTableTableManager(_$GemiDatabase db, $BudgetsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  ...
                  BaseReferences<_$GemiDatabase, $BudgetsTable, Budget>(
                    db,
                    table,
                    e,
                  ),
