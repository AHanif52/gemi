...
class KategoriTotal {
  const KategoriTotal({required this.kategori, required this.total, required this.jumlah});
...
class Ringkasan {
  const Ringkasan({required this.dari, required this.sampai, required this.masuk, required this.keluar, required this.keluarPerHari, required this.keluarPerKategori});
